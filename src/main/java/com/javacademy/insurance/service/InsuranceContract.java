...
public class InsuranceContract {
     ...
     public InsuranceContract(String number, BigDecimal price, BigDecimal costOfCoverage, Currency currency,
                              String fullName, Country country, TypeOfInsurance typeOfInsurance,
                              ContractStatus contractStatus) {
          this.number = number;
          this.price = price;
